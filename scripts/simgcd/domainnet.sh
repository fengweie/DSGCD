...
# WEIGHTS_PATH=/mnt/sdb/fengwei/GCD_natural/HiLo-main/data/sample_weights/domainnet/clipart.json
        ...
        for e in ${!ENVs1[@]}; do
            for ee in ${!ENVs2[@]}; do
                if [ ${ENVs1[$e]} != ${ENVs2[$ee]} ]; then
                    ...
                    WEIGHTS_PATH=/mnt/sdb/fengwei/GCD_natural/HiLo-main/data/sample_weights/domainnet/${ENVs2[$ee]}.json
